...
categories: [OverTheWire, Writeup]                     # Change Templates to Writeup
...
image:
  path: /assets/img/images/OverTheWire/OTW.png
...
*   Connecting using SSH
    ...
    * password: bandit0
    ...
    ![Untitled](/assets/img/images/OverTheWire/Bandit/Untitled.png)
...
*   password: boJ9jbbUNNfktd78OOpsqOltutMc3MY1
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 1.png" alt="Untitled" data-size="original">
...
* there is many commands will not work like:
  *   `cat -`
      ...
      <img src="/assets/img/images/OverTheWire/Bandit/Untitled 2.png" alt="Untitled" data-size="original">
  *   `cat -- -`

      <img src="/assets/img/images/OverTheWire/Bandit/Untitled 3.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 4.png" alt="Untitled" data-size="original">

<img src="/assets/img/images/OverTheWire/Bandit/Untitled 5.png" alt="Untitled" data-size="original">
...
*   we will use double quotes to cat a file that contains spaces in it’s name
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 6.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 7.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 8.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 9.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 10.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 11.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 12.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 13.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 14.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 15.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 16.png" alt="Untitled" data-size="original">
...
*   cp data.txt to our directory
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 17.png" alt="Untitled" data-size="original">

    ***
* alright, let's search for any program to deal with hexdump
*   we can use `**apropos hexdump**`

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 18.png" alt="Untitled" data-size="original">
* great, it seems `xxd` will help us here
*   lets learn more about it using `--help` option

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 19.png" alt="Untitled" data-size="original">
...
*   let’s check the file type using `file data` command, it’s gzip compressed data, so we will rename the file to “data.gz”
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 20.png" alt="Untitled" data-size="original">
...
*   gzip decompress
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 21.png" alt="Untitled" data-size="original">
...
*   after checking the file type again we will see it is bzip2 file, so let’s rename the file to “data.bz2”
    ...
    * `**bandit12@bandit:/tmp/juba$ mv compressed.bz compressed.bz2**`
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 22.png" alt="Untitled" data-size="original">

    ***
*   gzip decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 23.png" alt="Untitled" data-size="original">

    ***
*   Tar decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 24.png" alt="Untitled" data-size="original">

    ***
*   POSIX tar decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 25.png" alt="Untitled" data-size="original">

    ***
*   bzip2 decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 26.png" alt="Untitled" data-size="original">

    ***
*   tar decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 27.png" alt="Untitled" data-size="original">

    ***
*   gzip decompress

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 28.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 29.png" alt="Untitled" data-size="original">
...
*   we know from the previous task that bandit14 password is stored in /etc/bandit\_pass/bandit14
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 30.png" alt="Untitled" data-size="original">
...
*   as we can see if we get the content of the website we can’t see the password unless we submit our password
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 31.png" alt="Untitled" data-size="original">
*   we can use netcat to submit our password

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 32.png" alt="Untitled" data-size="original">
...
*   Let’s check the manual page for netcat using `man` command
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 33.png" alt="Untitled" data-size="original">

    * can’t find any helpful option
*   let’s try ncat

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 34.png" alt="Untitled" data-size="original">

    * Great point, now we can use ncat
*   `**ncat --ssl 127.0.0.1 30001**`

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 35.png" alt="Untitled" data-size="original">
...
*   Start nmap scan using -p to specify the ports
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 36.png" alt="Untitled" data-size="original">
*   we can check them manually

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 37.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 38.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 39.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 40.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 41.png" alt="Untitled" data-size="original">
*   as we can see there are two ports that use SSL (31518, 31790), Let’s check them

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 42.png" alt="Untitled" data-size="original">

    * it seems this is the wrong one
*   port 31790

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 43.png" alt="Untitled" data-size="original">
...
*   I’m going to use `vimdiff`
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 44.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 45.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 46.png" alt="Untitled" data-size="original">

* We can see `-t` option could help us
* Let’s try to connect using `**-t <shell>**`

<img src="/assets/img/images/OverTheWire/Bandit/Untitled 47.png" alt="Untitled" data-size="original">
...
*   if we check `**whoami` we can see bandit20 like below:\*\*
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 48.png" alt="Untitled" data-size="original">
*   Let’s get bandit20 password by viewing the /etc/bandit\_pass/bandit20 file content

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 49.png" alt="Untitled" data-size="original">
...
*   **NOTE:** Try connecting to your own network daemon to see if it works as you think
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 50.png" alt="Untitled" data-size="original">
...
*   Let’s use suconnect to connect to our listening port, then enter bandit20 password
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 51.png" alt="Untitled" data-size="original">
...
*   Let’s check cron.d directory
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 52.png" alt="Untitled" data-size="original">
*   we can see that bandit22 cronjob in /usr/bin/cronjob\_bandit22.sh, so let’s check it

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 53.png" alt="Untitled" data-size="original">
*   as we can see this script will change the mode to 644 for a file called “t7O6lds9S0RqQh9aMcz6ShpAoZKF7fgv” in /tmp, then will cat bandit22 password and redirect it to this file
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 54.png" alt="Untitled" data-size="original">
*   It’s very easy to access the password, just read the file “/tmp/t7O6lds9S0RqQh9aMcz6ShpAoZKF7fgv”

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 55.png" alt="Untitled" data-size="original">
...
*   let’s check the cronjob\_bandit23 file
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 56.png" alt="Untitled" data-size="original">
*   view /usr/bin/cronjob\_bandit23.sh

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 57.png" alt="Untitled" data-size="original">
    ...
    * line5: hash the text “I am user username“ using md5sum hash algorithm then split the output and save the output in a variable called mytarget
      *   to demonstrate this we will try it by ourself
          ...
          <img src="/assets/img/images/OverTheWire/Bandit/Untitled 58.png" alt="Untitled" data-size="original">
      *   if we don’t cut the output we will see this output:

          <img src="/assets/img/images/OverTheWire/Bandit/Untitled 59.png" alt="Untitled" data-size="original">
...
*   let’s continue the script by assigning mytarget variable using `mytarget=$(echo I am user $myname | md5sum | cut -d ' ' -f 1)`
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 60.png" alt="Untitled" data-size="original">
*   now we know the file name, let’s get the password

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 61.png" alt="Untitled" data-size="original">
...
*   Let’s navigate to /etc/cron.d to see all cron jobs
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 62.png" alt="Untitled" data-size="original">

    * well, let’s show cronjob\_bandit24 content

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 63.png" alt="Untitled" data-size="original">
*   let’s check /usr/bin/cronjob\_bandit24.sh

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 64.png" alt="Untitled" data-size="original">
...
*   great, we have got the password
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 65.png" alt="Untitled" data-size="original">
...
*   if we connected without any input we will see the following
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 66.png" alt="Untitled" data-size="original">
...
*   if we tried to brute force the PIN code we will see this
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 67.png" alt="Untitled" data-size="original">
*   so, let's remove these lines by adding `**| grep -v 'Try again'**`

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 68.png" alt="Untitled" data-size="original">
...
*   we can check the shell for user bandit26 by viewing /etc/passwd file
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 69.png" alt="Untitled" data-size="original">
...
*   it seems showtext shell is printing this banner and exit to let’s try to use another shell, so let’s check /usr/bin/showtext
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 70.png" alt="Untitled" data-size="original">
*   Great, it’s not a binary file, let’s check if we can read it

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 71.png" alt="Untitled" data-size="original">
...
*   we can open an editor while using more by pressing `v` (vi by default), just make the terminal as small as possible you can, and you will find more tools
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 72.png" alt="Untitled" data-size="original">
*   great, press v

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 73.png" alt="Untitled" data-size="original">
* now we are using vim, so let’s get the password using vim command mode
*   `**:e /etc/bandit_pass/bandit26**`

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 74.png" alt="Untitled" data-size="original">
...
*   list files
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 75.png" alt="Untitled" data-size="original">
*   we have ‘bandit27-do’ binary file

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 76.png" alt="Untitled" data-size="original">
...
*   we can’t clone the repository in our home directory, so we should navigate to /tmp and create a directory we can write in
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 77.png" alt="Untitled" data-size="original">
*   now we can clone the repository with bandit27 password

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 78.png" alt="Untitled" data-size="original">
*   the password is easy to get, just navigate to the repository and read ‘README’ file

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 79.png" alt="Untitled" data-size="original">
...
* The same first steps for bandit27
  ...
  *   clone the repository using bandit28 password
      ...
      <img src="/assets/img/images/OverTheWire/Bandit/Untitled 80.png" alt="Untitled" data-size="original">
*   README.md content
...
*   nothing interesting, but we can see git commits history
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 81.png" alt="Untitled" data-size="original">
*   the third commit have an interesting comment ‘fix info leak’, so let’s check it

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 82.png" alt="Untitled" data-size="original">
...
*   checking commits
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 83.png" alt="Untitled" data-size="original">
*   checking branches

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 84.png" alt="Untitled" data-size="original">
* great, there are other branches
*   switch the branch

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 85.png" alt="Untitled" data-size="original">

<img src="/assets/img/images/OverTheWire/Bandit/Untitled 86.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 87.png" alt="Untitled" data-size="original">

*   checking commits and branches

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 88.png" alt="Untitled" data-size="original">
*   after switching to master branch I did not find anything interesting, so let’s check the tags

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 89.png" alt="Untitled" data-size="original">
...
<img src="/assets/img/images/OverTheWire/Bandit/Untitled 90.png" alt="Untitled" data-size="original">

*   create and add key.txt file

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 91.png" alt="Untitled" data-size="original">
*   commit and push the file

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 92.png" alt="Untitled" data-size="original">
...
*   login banner
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 93.png" alt="Untitled" data-size="original">

    * as we can see at the button it’s UPPERCASE SHELL
*   Let’s search for the next password the system

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 94.png" alt="Untitled" data-size="original">
*   we can’t use the basic commands, let’s try it with uppercase

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 95.png" alt="Untitled" data-size="original">
...
*   the following is a demonstration of this
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 96.png" alt="Untitled" data-size="original">
...
*   demo:
    ...
    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 97.png" alt="Untitled" data-size="original">
*   great, let’s to this

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 98.png" alt="Untitled" data-size="original">
*   Let’s search for any interesting information

    <img src="/assets/img/images/OverTheWire/Bandit/Untitled 99.png" alt="Untitled" data-size="original">
