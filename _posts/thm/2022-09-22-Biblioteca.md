...
image:
  path: /assets/img/images/thm/biblioteca/biblioteca.png
  width: 800
  height: 500
  alt: Bibioteca logo
---
...
![Untitled](/assets/img/images/thm/biblioteca/login.png)
...
- so the query becomes 
  ...
  SELECT * FROM site_users WHERE username='' OR 1=1
    ```
![Untitled](/assets/img/images/thm/biblioteca/sqli.png)
...
![Untitled](/assets/img/images/thm/biblioteca/smokey.png)

## Local Enumeration

![Untitled](/assets/img/images/thm/biblioteca/LEnum.png)
...
![Untitled](/assets/img/images/thm/biblioteca/root.png)
