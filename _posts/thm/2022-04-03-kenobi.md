...
image:
  path: /assets/img/images/thm/Kenobi/OcA2KrK.gif
...
![OcA2KrK.gif](/assets/img/images/thm/Kenobi/OcA2KrK.gif)
...
![Untitled](/assets/img/images/thm/Kenobi/Untitled.png)

![Untitled](</assets/img/images/thm/Kenobi/Untitled 1.png>)
...
*   smap scripts saved list in a databases in `/usr/share/nmap/scripts/scripts.db` , let’s check smb enumeration scripts
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 2.png" alt="Untitled" data-size="original">
...
*   if you remember we know the version of ProFtpd from our nmap scan, so let's check this again
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 3.png" alt="Untitled" data-size="original">
...
*   as we can see there is many exploits, but we can filtrate them by searching for 1.3.5 (the version), so they are 4 exploits
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 4.png" alt="Untitled" data-size="original">
...
*   We're now going to copy Kenobi's private key using SITE CPFR and SITE CPTO commands.
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 5.png" alt="Untitled" data-size="original">
...
![Untitled](</assets/img/images/thm/Kenobi/Untitled 6.png>)

* Great, Let’s use this ssh private key to login as kenobi

![Untitled](</assets/img/images/thm/Kenobi/Untitled 7.png>)

> Question11: What is Kenobi's user flag (/home/kenobi/user.txt)?
>
> <img src="/assets/img/images/thm/Kenobi/Untitled 8.png" alt="Untitled" data-size="original">
>
...
*   Let’s run this binary
    ...
    * as we can see, there are 3 options we can use
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 9.png" alt="Untitled" data-size="original">

    * Options:
      *   First option

          <img src="/assets/img/images/thm/Kenobi/Untitled 10.png" alt="Untitled" data-size="original">
      *   Second option

          <img src="/assets/img/images/thm/Kenobi/Untitled 11.png" alt="Untitled" data-size="original">
      *   Third option

          <img src="/assets/img/images/thm/Kenobi/Untitled 12.png" alt="Untitled" data-size="original">
...
*   then we should make it executable using `chmod +x ifconfig` , and append /tmp directory to the PATH env
    ...
    <img src="/assets/img/images/thm/Kenobi/Untitled 13.png" alt="Untitled" data-size="original">
*   if we run `/usr/bin/menu` and choose 3 to run `ifconfig`

    <img src="/assets/img/images/thm/Kenobi/Untitled 14.png" alt="Untitled" data-size="original">

    * we can see that netcat listener started so we can connect using our kali Linux machine

    <img src="/assets/img/images/thm/Kenobi/Untitled 15.png" alt="Untitled" data-size="original">
...
>
>     <img src="/assets/img/images/thm/Kenobi/Untitled 16.png" alt="Untitled" data-size="original">
>
>     * Gotcha!
