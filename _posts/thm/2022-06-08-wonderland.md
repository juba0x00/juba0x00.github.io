...
image:
  path: /assets/img/images/thm/Wonderland/Untitled 1.png 
...
*   the website:
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 2.png" alt="Untitled" data-size="original">
*   look for any interesting information on the site Source

    <img src="/assets/img/images/thm/Wonderland/Untitled 3.png" alt="Untitled" data-size="original">
...
*   Let’s do some fuzzing using `feroxbuster`
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 4.png" alt="Untitled" data-size="original">
* it seems that the directory is rabbit, like: /r/a/b/b/i/t

![Untitled](</assets/img/images/thm/Wonderland/Untitled 5.png>)

![Untitled](</assets/img/images/thm/Wonderland/Untitled 6.png>)

![Untitled](</assets/img/images/thm/Wonderland/Untitled 7.png>)

![Untitled](</assets/img/images/thm/Wonderland/Untitled 8.png>)

![Untitled](</assets/img/images/thm/Wonderland/Untitled 9.png>)

![Untitled](</assets/img/images/thm/Wonderland/Untitled 10.png>)

*   After checking the sources of these pages, we found this interesting information in `/r/a/b/b/i/t` path

    <img src="/assets/img/images/thm/Wonderland/Untitled 11.png" alt="Untitled" data-size="original">
...
*   let’s check if this is a valid credential using ssh (we know that ssh is running from our nmap scan
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 12.png" alt="Untitled" data-size="original">
...
*   we can’t view root.txt content
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 13.png" alt="Untitled" data-size="original">
...
![Untitled](</assets/img/images/thm/Wonderland/Untitled 14.png>)
...
*   in the first line, we can see it imports `random` module, so we can do python module Hijacking by creating `random.py` file in the same directory using `touch random.py` command
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 15.png" alt="Untitled" data-size="original">
*   run the script to make sure it runs as rabbit

    <img src="/assets/img/images/thm/Wonderland/Untitled 16.png" alt="Untitled" data-size="original">

    * as we can notice the user running the script is rabbit
*   let’s inject our malicious script

    <img src="/assets/img/images/thm/Wonderland/Untitled 17.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/thm/Wonderland/Untitled 18.png" alt="Untitled" data-size="original">
...
*   discovering rabbit home directory
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 19.png" alt="Untitled" data-size="original">
...
*   strings command is not installed, so we will copy teaParty to our system (strings: print the sequences of printable characters in files)
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 20.png" alt="Untitled" data-size="original">
*   transferring teaParty using netcat

    <img src="/assets/img/images/thm/Wonderland/Untitled 21.png" alt="Untitled" data-size="original">
*   teaParty content:
...
*   write a script to check our plan
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 22.png" alt="Untitled" data-size="original">
*   give execution permission for all users

    <img src="/assets/img/images/thm/Wonderland/Untitled 23.png" alt="Untitled" data-size="original">
*   run teaParty

    <img src="/assets/img/images/thm/Wonderland/Untitled 24.png" alt="Untitled" data-size="original">
*   as we can see we are hatter, so let’s inject our malicious script it’s just adding (`/bin/bash`) 😊 to get the shell

    <img src="/assets/img/images/thm/Wonderland/Untitled 25.png" alt="Untitled" data-size="original">
...
*   discovering hatter home directory
    ...
    <img src="/assets/img/images/thm/Wonderland/Untitled 26.png" alt="Untitled" data-size="original">
*   we found a password but I don’t know if it’s the root password or hatter’s password, so let’s try it

    <img src="/assets/img/images/thm/Wonderland/Untitled 27.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/thm/Wonderland/Untitled 28.png" alt="Untitled" data-size="original">
...
![Untitled](</assets/img/images/thm/Wonderland/Untitled 29.png>)
...
![Untitled](</assets/img/images/thm/Wonderland/Untitled 30.png>)

***

## user flag

![Untitled](</assets/img/images/thm/Wonderland/Untitled 31.png>)
