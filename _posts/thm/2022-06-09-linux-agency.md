...
title: Hack The Box - Linux Agency                   # Add title of the machine here
...
image:
  path: /assets/img/images/thm/Linux-Agency/LinuxAgency.jpg
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 1.png)

***

### Mission 7 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 2.png)

***

### Mission 8 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 3.png)

***

### Mission 9 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 4.png)

***

### Mission 10 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 5.png)

*   it’s rockyou.txt wordlist, don’t `cat` it , it will explode into your terminal 😅, use grep to cut down the output

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 6.png" alt="Untitled" data-size="original">

***

### Mission 11 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 7.png)

***

### Mission 12 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 8.png)
...
*   first, we didn’t find anything inside mission11’s home so I searched for flag.txt but we didn’t find mission12s’ flag so we checked my Environment Variables (`env`), you also can echo the flag
    ...
    <img src="/assets/img/images/thm/Linux-Agency/Untitled 9.png" alt="Untitled" data-size="original">

***

### Mission 13 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 10.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 11.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 12.png)

* it’s binary, we need to convert it into ASCII text

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 13.png)

* Just hit the magic stick

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 14.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 15.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 16.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 17.png)

***

### Mission 18 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 18.png)

***

### Mission 19 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 19.png)

***

### Mission 20 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 20.png)

***

### Mission 21 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 21.png)

***

### Mission 22 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 22.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 23.png)

***

### Mission 23 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 24.png)

* it’s python interactive shell, I think mission22 `.bashrc` file starts python whenever mission22 log in

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 25.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 26.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 27.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 28.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 29.png)

*   we found the following in `.viminfo` file

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 30.png" alt="Untitled" data-size="original">
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 31.png)

***

### Mission 26 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 32.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 33.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 34.png)

***

### Mission 28 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 35.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 36.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 37.png)
...
### viktor's Flag 
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 38.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 39.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 40.png)
...
*   first We checked our privileges using `sudo -l` but we have no permission to run `sudo` after enumerating `/etc/shadow` (check if it’s readable), `/etc/crontab` we found a corn job for Dalia `sleep30;/opt/scripts/[47.sh](http://47.sh)` and a cron job for root (overwrite 47.sh file and make viktor (the current user we use) the owner, let’s inject bash script to start a listener
    ...
    <img src="/assets/img/images/thm/Linux-Agency/Untitled 41.png" alt="Untitled" data-size="original">
*   We created a pipe then we started `netcat` listener redirecting the input from `f` and the output to `bash` which output redirected to `f`
    ...
    <img src="/assets/img/images/thm/Linux-Agency/Untitled 42.png" alt="Untitled" data-size="original">
*   Stabilizing the shell

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 43.png" alt="Untitled" data-size="original">
*   Gotcha

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 44.png" alt="Untitled" data-size="original">

    ***

    *   Another Easy way

        <img src="/assets/img/images/thm/Linux-Agency/Untitled 45.png" alt="Untitled" data-size="original">

***

### Silvio’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 46.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 47.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 48.png)

***

### Reza’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 49.png)
...
*   [GTFOBins](https://gtfobins.github.io/gtfobins/git/#sudo)
    ...
    <img src="/assets/img/images/thm/Linux-Agency/Untitled 50.png" alt="Untitled" data-size="original">

***

### Jordan’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 51.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 52.png)
...
*   We are going to use `PYTHONPATH` Hijacking
    ...
    * What is `PYTHONPATH`
    ...
    <img src="/assets/img/images/thm/Linux-Agency/Untitled 53.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 54.png" alt="Untitled" data-size="original">

***

### Ken’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 55.png)

* [GTFOBins](https://gtfobins.github.io/gtfobins/less/#sudo)
*   `sudo -u ken less /etc/passwd`

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 56.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 57.png" alt="Untitled" data-size="original">

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 58.png" alt="Untitled" data-size="original">

***

### Sean’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 59.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 60.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 61.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 62.png)

***

### Maya’s flag 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 63.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 64.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 65.png)
...
![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 66.png)

***

### user.txt 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 67.png)

* Let’s use the ssh key with the Passphrase we cracked

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 68.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 69.png)

*   Oh😀 It’s `CVE-2019-14287`, It’s very easy to exploit

    <img src="/assets/img/images/thm/Linux-Agency/Untitled 70.png" alt="Untitled" data-size="original">

    * Just it😊
* There is a great TryHackMe room explains this vulnerability [here](https://tryhackme.com/room/sudovulnsbypass)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 71.png)

***

### root.txt 

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 72.png)

![Untitled](/assets/img/images/thm/Linux-Agency/Untitled 73.png)
