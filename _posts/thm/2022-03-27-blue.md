...
image:
  path: /assets/img/images/thm/Blue/blue.jpg
...
*   Show the exploit options
    ...
    <img src="/assets/img/images/thm/Blue/Untitled.png" alt="Untitled" data-size="original">
*   Set Required options

    <img src="/assets/img/images/thm/Blue/Untitled 1.png" alt="Untitled" data-size="original">
*   Start the exploit

    <img src="/assets/img/images/thm/Blue/Untitled 2.png" alt="Untitled" data-size="original">
...
*   post exploitation → getting meterpreter shell
    ...
    <img src="/assets/img/images/thm/Blue/Untitled 3.png" alt="Untitled" data-size="original">
*   Let's check all the sessions we have now

    <img src="/assets/img/images/thm/Blue/Untitled 4.png" alt="Untitled" data-size="original">
* Great, We Have Meterpreter shell
*   list all the processes to migrate to another process

    <img src="/assets/img/images/thm/Blue/Untitled 5.png" alt="Untitled" data-size="original">
...
*   Dump users passwords
    ...
    <img src="/assets/img/images/thm/Blue/Untitled 6.png" alt="Untitled" data-size="original">
...
*   the first flag in the root directory → **C:\ we will type `cd C:\\` because Meterpreter does some handling will the backslash**
    ...
    <img src="/assets/img/images/thm/Blue/Untitled 7.png" alt="Untitled" data-size="original">

    * Great, That’s the first flag
* The second flag at the location where passwords are stored
*   it is **C:\Windows\System32\config**

    <img src="/assets/img/images/thm/Blue/Untitled 8.png" alt="Untitled" data-size="original">
...
*   the third flag → “_Administrators usually have pretty interesting things saved._” I think it is in Jon's home folder
    ...
    * After Searching it’s in the Documents folder
    ...
    <img src="/assets/img/images/thm/Blue/Untitled 9.png" alt="Untitled" data-size="original">

***

[Blue Badge](https://tryhackme.com/Juba0x430x55/badges/blue) ![my Blue Bade](/assets/img/images/thm/Blue/mybadge)
